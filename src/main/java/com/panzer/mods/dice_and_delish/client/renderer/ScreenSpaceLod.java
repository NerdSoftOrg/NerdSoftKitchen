...
final class ScreenSpaceLod {
    ...
    @SuppressWarnings("SameParameterValue")
    static boolean isPastThreshold(long packedPos, @SuppressWarnings("SameParameterValue") double radiusSqr, double distanceSqr, double coverageThreshold) {
    ...
    @SuppressWarnings("unused")
    public static void forgetChunkPos(ChunkPos pos) {
