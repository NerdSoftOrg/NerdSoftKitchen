...
public class IronCupItem extends Item {
    ...
    public @NotNull Component getName(@NotNull ItemStack stack) {
        ...
        return Component.translatable("dice_and_delish.iron_cup.filled_name",
                Component.translatable("dice_and_delish.iron_cup_content." + content.getSerializedName()));
    }
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context,
        ...
        IronCupContent content = contentOf(stack);
        if (content == IronCupContent.MILK) {
            tooltip.add(Component.translatable("dice_and_delish.iron_cup.tooltip.milk").withStyle(ChatFormatting.GRAY));
        } else if (content == IronCupContent.LIQUID_EGG) {
            tooltip.add(Component.translatable("dice_and_delish.iron_cup.tooltip.liquid_egg").withStyle(ChatFormatting.GRAY));
        }

        if (!flag.isAdvanced()) return;
        if (content != null) {
            tooltip.add(Component.translatable("dice_and_delish.iron_cup_content.contains",
                            Component.translatable("dice_and_delish.iron_cup_content." + content.getSerializedName()))
